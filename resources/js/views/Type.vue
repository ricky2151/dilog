        ...
        <v-dialog v-model="dialog_createedit" width=750>
            <v-card>
                <v-toolbar dark color="menu">
                    ...
                    <v-toolbar-title v-html='id_data_edit == -1 ?"Add Type":"Edit Type"'></v-toolbar-title>
        ...
        <v-layout row class='bgwhite margintop10'>
            <v-flex xs6>
                <div class='marginleft30 margintop10'>
                    <v-icon class='icontitledatatable'>bookmarks</v-icon>
                    <h2 class='titledatatable'>Types Data</h2>
...
export default {
    ...
    methods: {
        ...
        showTable(r) 
        {
            this.data_table = r.data.items.types;
        },
